...
title: "概覽"
icon: "hand-wave"
description: "介紹安裝 Activepieces 的不同方式"
---

Activepieces 社群版 (Community Edition) 可以使用 **Docker**、**Docker Compose** 和 **Kubernetes** 進行部署。

<Tip>
社群版是**免費**且**開源**的。

您可以在[這裡](https://www.activepieces.com/pricing)閱讀不同版本之間的差異。
</Tip>

## 推薦選項

<CardGroup cols={2}>
  <Card title="Docker (最快)" icon="docker" color="#248fe0" href="./options/docker_zh_TW">
使用 PGLite 資料庫將 Activepieces 部署為單個 Docker 容器。
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose_zh_TW">
    部署包含 **Redis** 和 **PostgreSQL** 設定的 Activepieces。
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Helm" icon="ship" color="#ff9900" href="./options/helm_zh_TW">
    使用 Helm 安裝在 Kubernetes 上。
  </Card>

  <Card title="Railway" icon={
    <img src="https://railway.com/brand/logo-light.png" alt="Railway" width="24" height="24" />
  } href="./options/railway_zh_TW">
    在 Railway 上一鍵安裝。
  </Card>
  ...
  <Card title="Easypanel" icon={
        ...
        } href="./options/easypanel_zh_TW">
   使用由社群維護的 Easypanel 模板一鍵安裝。
  </Card>

  <Card title="Elestio" icon="cloud" color="#ff9900" href="./options/elestio_zh_TW">
    在 Elestio 上一鍵安裝。
  </Card>

  <Card title="AWS (Pulumi)" icon="aws" color="#ff9900" href="./options/aws_zh_TW">
    使用 Pulumi 安裝在 AWS 上。
  </Card>

  <Card title="GCP" icon="cloud" color="#4385f5" href="./options/gcp_zh_TW">
    以 VM 模板形式安裝在 GCP 上。
  </Card>
...
<CardGroup cols={2}>
  <Card title="Activepieces 雲端版" icon="cloud" color="##5155D7" href="https://cloud.activepieces.com/">
   這是最快的選項。
  </Card>
</CardGroup>